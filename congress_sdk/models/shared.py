...
class Title(BaseModel):
    ...
    title_type_code: Annotated[Optional[int], Field(alias="titleTypeCode", default=None, description="What the title type code is.")] = None
    update_date: Annotated[Optional[datetime], Field(alias="updateDate", default=None, description="When the title was last updated.")] = None
