...
from congress_sdk.config import CONGRESS_API_KEY, CONGRESS_STRICT_FIELD_CHECK
from congress_sdk.models.endpoint_spec import EndpointSpec
...
class CDGClient:
    ...
    def coerce_records(
        ...
        for r in records:
            ...
            try:
                if spec is not None:
                    from congress_sdk.data_collection.id_strategy import apply_id_strategy
