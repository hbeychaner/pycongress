...
from congress_sdk.models.endpoint_spec import EndpointSpec as ModelEndpointSpec
from congress_sdk.models.other_models import BoundCongressionalRecordListItem
...
item_spec = EndpointSpec(
    ...
    data_key=None,
    unwrap_key="boundCongressionalRecord",
    response_model=BoundCongressionalRecordListItem,
    id_strategy=ModelEndpointSpec.IdStrategy(
        reference_from="url", unique_from=["date"], section_bounds="sections.0"
    ),
